      ...
      <div className="contacts_section flex flex-col">
        ...
        <div className="infos_wrapper w-full flex pt-7 gap-8 ">
          <div className="infos flex flex-col w-[calc(((100%/12)*4)-32px)] gap-8">
            ...
            <p className="text-lg text-[rgb(67,67,67)]">{t("address")}</p>
            <p className="text-lg text-[rgb(67,67,67)]">{t("workingtime")}</p>
            <p className="text-lg text-[rgb(67,67,67)]">{t("dayoff")}</p>
          </div>
          {/* <YandexMapComponent /> */}
          <iframe
            id="map"
            src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3017.5387800312906!2d71.4601560760331!3d40.860048971371604!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNDDCsDUxJzM2LjIiTiA3McKwMjcnNDUuOCJF!5e0!3m2!1sen!2s!4v1731851579334!5m2!1sen!2s"
            width="600"
            height="422"
            ...
            className="w-[calc(((100%/12)*8)-32px)]"
          ></iframe>
        </div>
      </div>
    </div>
